...
| 路径 | 说明 | 主要技术 |
|------|------|----------|
| [projects/particles/](projects/particles/) | 3D 手势塔罗牌抽取：输入问题后用「张开手 → 握拳 → 张开手」的手势在 3D 牌阵中抽取塔罗牌 | Three.js、MediaPipe Hands |
| [trust/](trust/) | 《信任的进化》中文网页复活版——Nicky Case 博弈论互动游戏的本地化部署与移动端适配 | PIXI.js、Howler.js |
| [projects/nutrition/](projects/nutrition/) | 营养素计算器：根据生活化减脂理论，输入性别、体重和运动量即可估算每日碳水、蛋白质和脂肪目标 | 原生 JS（OOP） |
...
| [assignments/](assignments/) | 作业与思路归档：课程作业展示入口及外部文档链接 | HTML |
