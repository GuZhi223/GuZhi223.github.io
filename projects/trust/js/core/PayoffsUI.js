function PayoffsUI(config){
	...
	// Labels
	dom.appendChild(_makeLabel("label_cooperate", {x:158, y:27, rotation:45, align:"center", color:"#cccccc", size:15, width:70, lineHeight:1}));
	dom.appendChild(_makeLabel("label_cooperate", {x:62, y:27, rotation:-45, align:"center", color:"#cccccc", size:15, width:70, lineHeight:1}));
	dom.appendChild(_makeLabel("label_cheat", {x:235, y:100, rotation:45, align:"center", color:"#cccccc", size:15, width:70, lineHeight:1}));
	dom.appendChild(_makeLabel("label_cheat", {x:-4, y:100, rotation:-45, align:"center", color:"#cccccc", size:15, width:70, lineHeight:1}));
